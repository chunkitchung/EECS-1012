    ...
    var c = document.getElementById("num3").value;
     ...
     if (discriminant<0) {
        ...
        if (root1 != possibleRoot) {
           ...
           document.getElementById("output").innerHTML = "It has two distinct roots";
        } 
        else if (root1 == possibleRoot) {
            document.getElementById("output").innerHTML = "It roots are identical";
        }
        else {
           var root1 = root1.toFixed(2);
           document.getElementById("output").innerHTML = "It has one distinct root";
